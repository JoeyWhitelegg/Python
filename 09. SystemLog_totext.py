# write the Windows system event log to a plaintext file
...
if __name__ == "__main__":
    ...
    # the system logs are written to the file system_log.txt
    logs = get_event_logs(server, log_type)
    if logs:
        write_logs_to_file(logs, output_file)
        print(f"System log has been written to {output_file}")
    else:
