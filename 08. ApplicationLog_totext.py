# write the Windows application event log to a plaintext file
...
if __name__ == "__main__":
    ...
    output_file = "application_log.txt"

    # the application logs are written to the file application_log.txt
    logs = get_event_logs(server, log_type)
    if logs:
        write_logs_to_file(logs, output_file)
        print(f"Application log has been written to {output_file}")
    else:
